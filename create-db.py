...
def createDB():
  ...
  syllables_max = 0
  words = 0
  line = "Word, S0, S1, S2, S3, S4, S5, S6, S7, S8, S9, SCOUNT, P01, P02, P03, P04, P05, P06, P07, P08, P09, P10,"
  line = line + "P11, P12, P13, P14, P15, P16, P17, P18, P19, P20, P21, P22, P23, P24, P25, P26, P27, P28, PCOUNT"
  file = open('words_alpha.txt','r')
  writefile = open('words_meta.txt','w')
  writefile.write(line + '\n')
  while True:
    word_s = file.readline().strip()
    if not word_s:
      break
    ...
    if syllables == None or phones == None:
      print(word_s + " is not in the dictionary", syllables_count, phones_count)
    else:
      print(f"WORD({word_s!r}) yields {syllables} SYLABLE COUNT is {syllables_count} Phones {phones}")
      words = words +1
      if syllables_count > syllables_max:
        syllables_max = syllables_count
      if phones_count > phones_max:
        phones_max = phones_count
      line = word_s
      for syl in syllables:
        line = line + ", " + syl
      count = 10 - syllables_count
      if count > 0:
        line = line + ", " * count
      line = line + ", " + str(syllables_count)
      for phon in phones:
        line = line + ", " + phon
      count = 28 - phones_count
      if count > 0:
        line = line + ", " * count
      line = line + ", " + str(phones_count)
      print(line)
      writefile.write(line + '\n')

  print(words, syllables_max, phones_max)
  writefile.close()
